...
% with lambda = 0
[w_reg1, train_1, valid_1] = lr_test('stdev1', 0, true);
[w_reg2, train_2, valid_2] = lr_test('stdev2', 0, true);
[w_reg3, train_3, valid_3] = lr_test('stdev4', 0, true);
[w_reg4, train_4, valid_4] = lr_test('nonsep', 0, true);
...
for i = 1:length(LAMBDA_RANGE)
    ...
    [w_reg1_1, tmp, valid_score_matrix(i, 1)]= lr_test('stdev1', lambda_i, false);
    [w_reg2_1, tmp, valid_score_matrix(i, 2)]= lr_test('stdev2', lambda_i, false);
    [w_reg3_1, tmp, valid_score_matrix(i, 3)]= lr_test('stdev4', lambda_i, false);
    [w_reg4_1, tmp, valid_score_matrix(i, 4)]= lr_test('nonsep', lambda_i, false);
end
valid_score_matrix

...
if toPlot
    ...
    plotDecisionBoundary(X, Y, predictLR, [0.7, 0.5, 0.3], '',... %strcat('LR Training, lambda = ', num2str(lambda)), ...
        strcat('hw2_writeup/hw2_1_',name,'_a_',num2str(lambda),'.pdf'));


    % plot validation results
    plotDecisionBoundary(X_val, Y_val, predictLR, [0.7, 0.5, 0.3],'', ... %strcat('LR Validate, lambda = ', num2str(lambda)), ...
